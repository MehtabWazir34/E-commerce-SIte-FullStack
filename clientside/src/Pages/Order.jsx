...
function Order(){
    ...
    return(
        <section className="max-w-7xl rounded-2xl min-h-screen mx-auto bg-[#2c3936] mt-8 p-6 grid grid-cols-1 md:grid-cols-2 ">
            <div className="shadow-lg rounded-2xl border border-[#ffe2af] p-4 mb-8">
                <h2 className="text-2xl text-left text-[#ffe2af] font-bold border-b-2 border-[#ffe2af] max-w-1/6 md:w-full pb-2">Order Summary</h2>
                <div>
            ...
            <form className="flex flex-col shadow-2xl md:max-w-2/3 rounded-2xl space-y-2 mx-auto border border-[#ffe2af] gap-4 mb-8 p-4">
            <div className="text-center mt-4 mb-12">
            <h2 className="text-center text-2xl text-[#ffe2af]">Fill the Form</h2>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 place-items-center gap-2 w-full">
